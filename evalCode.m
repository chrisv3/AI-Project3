% Evaluation code for recognition
%
% Your goal is to implement a cat vs dog classifier
%
%
...
param.feature = 'default'; % or tinyimage, bow-patches, bow-sift (optionally gist)
param.classifier = 'svm'; % or 'knn'
...
classifier = trainClassifier(features(:, trainSet), ...
                            imdb.images.classId(trainSet), param);
